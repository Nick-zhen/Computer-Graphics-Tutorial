...
function checkKeyboard() {
  ...
  if (keyboard.pressed("W")) armadilloFrame.translateZ(.1);
  if (keyboard.pressed("A")) armadilloFrame.translateX(.1);
  if (keyboard.pressed("S")) armadilloFrame.translateZ(-.1);
  if (keyboard.pressed("D")) armadilloFrame.translateX(-.1);
  if (keyboard.pressed("Q")) armadilloFrame.rotateY(.1);
  if (keyboard.pressed("E")) armadilloFrame.rotateY(-.1);
